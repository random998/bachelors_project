...
impl ConnectionStats {
    ...
    pub fn inc_sent(&mut self)          { self.sent_msgs += 1; }
    pub fn inc_recv(&mut self)          { self.recv_msgs += 1; }
    pub fn inc_dropped(&mut self)       { self.dropped   += 1; }
    pub fn set_peers(&mut self, n: usize) { self.peers = n;    }
    pub fn set_rtt(&mut self, rtt: Duration) { self.last_ping_rtt = Some(rtt); }
