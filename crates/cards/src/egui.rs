...
static CARD_IMAGES: LazyLock<AHashMap<Card, &'static [u8]>> = LazyLock::new(|| {
        ...
        cards.insert(Card::new(Rank::Deuce, Suit::Diamonds), BYTES_2_OF_DIAMONDS);
        cards.insert(Card::new(Rank::Trey, Suit::Diamonds), BYTES_3_OF_DIAMONDS);
        cards.insert(Card::new(Rank::Four, Suit::Diamonds), BYTES_4_OF_DIAMONDS);
        cards.insert(Card::new(Rank::Five, Suit::Diamonds), BYTES_5_OF_DIAMONDS);
        cards.insert(Card::new(Rank::Six, Suit::Diamonds), BYTES_6_OF_DIAMONDS);
        cards.insert(Card::new(Rank::Seven, Suit::Diamonds), BYTES_7_OF_DIAMONDS);
        cards.insert(Card::new(Rank::Eight, Suit::Diamonds), BYTES_8_OF_DIAMONDS);
        cards.insert(Card::new(Rank::Nine, Suit::Diamonds), BYTES_9_OF_DIAMONDS);
        cards.insert(Card::new(Rank::Ten, Suit::Diamonds), BYTES_10_OF_DIAMONDS);
        cards.insert(Card::new(Rank::Jack, Suit::Diamonds), BYTES_JACK_OF_DIAMONDS);
        cards.insert(Card::new(Rank::Queen, Suit::Diamonds), BYTES_QUEEN_OF_DIAMONDS);
        cards.insert(Card::new(Rank::King, Suit::Diamonds), BYTES_KING_OF_DIAMONDS);
        cards.insert(Card::new(Rank::Ace, Suit::Diamonds), BYTES_ACE_OF_DIAMONDS);
        ...
        cards.insert(Card::new(Rank::Queen, Suit::Hearts), BYTES_QUEEN_OF_HEARTS);
        ...
        cards.insert(Card::new(Rank::Queen, Suit::Spades), BYTES_QUEEN_OF_SPADES);
...
impl Textures {
    ...
    pub fn new(ctx: &egui::Context) -> Self {
        ...
        let back = ctx.load_texture("back", image_from_memory(BYTES_CARD_BACK), Default::default());
